# Chapitre 7 : Fonctions - Référence Rapide
...
**Fonctions anonymes d'une ligne**
...
**L'ordre compte : positionnels, *args, nommés, **kwargs**
...
```python
# ❌ Incorrect : Modifier l'argument par défaut mutable
...
# ❌ Incorrect : Oublier de retourner
def add(a, b):
...
# ❌ Incorrect : Utiliser print au lieu de return
def add(a, b):
...
# ✅ Garder les fonctions focalisées (faire une chose)
...
# ✅ Utiliser des docstrings pour les fonctions complexes
