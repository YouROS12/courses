# Chapter 8: Tuples and Sets - Quick Reference
...
**Tuples have only 2 methods (they're immutable)**
...
| **Indexing** | ✅ Yes | ✅ Yes | ❌ No |
| **Syntax** | `[1, 2]` | `(1, 2)` | `{1, 2}` |
| **Use Case** | General collection | Immutable data, dict keys | Unique items, fast lookup |
...
```python
# ❌ Wrong: Single element tuple without comma
